...
const JWT_SECRET = process.env.JWT_SECRET || 'trusttrip-super-secret-key-change-in-production';
 ...
 */
export function generateToken(payload: Record<string, unknown>, expiresIn: string = JWT_EXPIRY): string {
